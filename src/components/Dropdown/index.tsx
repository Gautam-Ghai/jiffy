      ...
      {({ open }) => (
        <div className='flex flex-row space-x-2 mt-2'>
          ...
          <div className="relative">
            <Listbox.Button className="relative w-full bg-card-2 border-none rounded-md shadow-sm pl-3 pr-10 py-2 text-left cursor-pointer  sm:text-sm">
              <span className="flex items-center">
                <img src={selected.avatar} alt="" className="flex-shrink-0 h-6 w-6 rounded-full" />
                <span className="ml-3 block truncate text-gray-500">{selected.name}</span>
              </span>
            </Listbox.Button>
