...
interface Props {
    id?: number,
    username?: string,
    setParentComment?: Dispatch<SetStateAction<string>>
}
    ...
    return (
        <div className=''>
            <form className='flex flex-row items-center justify-start'>
                <TextareaAutosize className="bg-bgBlue-200 w-11/12 px-2 py-1.5 border-none rounded-lg caret-gray-500 text-gray-500 placeholder-gray-500 resize-none max-h-96" placeholder="comment" onChange={(e) => handleChange(e)} value={comment} rows={1}/>
