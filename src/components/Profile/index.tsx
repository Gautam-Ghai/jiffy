...
const Profile = (props: Props) => {
    return (
        <div className="bg-card text-white rounded-md drop-shadow-lg h-auto pb-6 hidden lg:block">
            <div className="w-full relative">
                <Image src={`${props.user.bannerImage || "/assets/default_banner_image.png"}`} alt='banner' height='105' width="380" className="rounded-t-md"/> 
                <div className="absolute left-4 top-20 rounded-full border-4 border-solid border-borderBlue bg-btnBlue h-20 w-20">
            ...
            <div className="bg-card-2 flex flex-row justify-evenly h-16 pt-2.5 my-4 ">
